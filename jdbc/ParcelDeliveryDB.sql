...
INSERT INTO Customers (CustomerID, FullName, Address, Email, Phone) VALUES
(1, 'John Doe', '123 Maple St', 'john.doe@example.com', '555-1234'),
(2, 'Jane Smith', '456 Oak Ave', 'jane.smith@example.com', '555-5678'),
(3, 'Bob Brown', '789 Pine Rd', 'bob.brown@example.com', '555-8765'),
(4, 'Alice Green', '101 Elm St', 'alice.green@example.com', '555-4321'),
(5, 'Tom White', '202 Cedar Ln', 'tom.white@example.com', '555-2345'),
(6, 'Sara Black', '303 Birch Blvd', 'sara.black@example.com', '555-3456'),
(7, 'Mike Gray', '404 Spruce Dr', 'mike.gray@example.com', '555-4567'),
(8, 'Emma Blue', '505 Ash Ct', 'emma.blue@example.com', '555-5678'),
(9, 'Lucas Red', '606 Willow Way', 'lucas.red@example.com', '555-6789'),
(10, 'Olivia Purple', '707 Fir Cir', 'olivia.purple@example.com', '555-7890');

-- Insert data into Parcels table
INSERT INTO Parcels (ParcelID, CustomerID, Weight, Dimensions, PickupDate, DeliveryDate, Status) VALUES
(1, 1, 2.5, '10x15x5', '2024-01-01', '2024-01-02', 'Delivered'),
(2, 2, 1.0, '5x10x5', '2024-01-02', '2024-01-03', 'In Transit'),
(3, 3, 3.5, '15x20x10', '2024-01-03', '2024-01-04', 'In Transit'),
(4, 4, 2.0, '10x10x10', '2024-01-04', '2024-01-05', 'Delivered'),
(5, 5, 1.5, '8x8x8', '2024-01-05', '2024-01-06', 'Delivered'),
(6, 6, 2.2, '10x15x10', '2024-01-06', '2024-01-07', 'Pending'),
(7, 7, 0.5, '5x5x5', '2024-01-07', '2024-01-08', 'In Transit'),
(8, 8, 3.0, '20x20x20', '2024-01-08', '2024-01-09', 'Delivered'),
(9, 9, 1.8, '12x12x12', '2024-01-09', '2024-01-10', 'Pending'),
(10, 10, 2.1, '15x15x5', '2024-01-10', '2024-01-11', 'Delivered');
